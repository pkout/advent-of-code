...
def calc_longest_travel_distance(travels, town_names_perms):
    longest_distance = 0
...
longest_dist = calc_longest_travel_distance(travels, town_names_permutations)

print(f'The longest path distance: {longest_dist}')
